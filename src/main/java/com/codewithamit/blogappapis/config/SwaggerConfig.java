...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course",
				"This project is developed by Learn Code With Amit", "1.0", "Terms of Service",
				new Contact("Amit", "https://www.javatpoint.com/spring-boot-tutorial", "amitharidwarchauhan@gmail.com"),
